...
int main()
{
	...
	do
	{
		...
		switch (cOpcion)
		{
			case 'a':
			{
				Fraccion f3 = fraccion1.sumaFraccion(fraccion2);
				f3.toString();
			}
			break;
			...
			case 'b':
			{
				Fraccion f3 = fraccion1.restaFraccion(fraccion2);
				f3.toString();
			}
			break;
			...
			case 'c':
			{
				Fraccion f3 = fraccion1.multiplicaFraccion(fraccion2);
				f3.toString();
			}
			break;
			...
			case 'd':
			{
				Fraccion f3 = fraccion1.divideFraccion(fraccion2);
				f3.toString();
			}
			break;
